  ...
  return (
    <Container className={classes.container}>
      <div className = {classes.div1}>
        ...
        <FormControl className={classes.formControl}>
        <InputLabel htmlFor="age-native-helper">興味や関心のある分野、技術1</InputLabel>
        <NativeSelect
          inputProps={{
            name: 'age',
            id: 'age-native-helper',
        ...
        <FormControl className={classes.formControl}>
        <InputLabel htmlFor="age-native-helper">興味や関心のある分野、技術2</InputLabel>
        <NativeSelect
          inputProps={{
            name: 'age',
            id: 'age-native-helper',
        ...
        <FormControl className={classes.formControl}> 
        <InputLabel htmlFor="age-native-helper">興味や関心のある分野、技術3</InputLabel>
        <NativeSelect
          inputProps={{
            name: 'age',
            id: 'age-native-helper',
